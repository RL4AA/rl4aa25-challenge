...
class Rewarder:
    ...
    def l2_norm_variance(self, state, target):
        """
    ...
    def l2_norm_alignment_distance(self, state, target):
        """
    ...
    def inverse_alignment_distance(self, state, target):
        """
    ...
    def quadratic_inverse_alignment_distance(self, state, target):
        """
    ...
    def logarithmic_scaling_inverse_alignment_distance(self, state, target):
        """
    ...
    def logarithmic_scaling_alignment_distance(self, state, target):
        """
    ...
    def progress_alignment_distance(self, state, prev_state, target):
        """
    ...
    def objective_progress(self, state, previous, target):
        """
    ...
    def compute_reward(self, state, prev_state, target, height, width):
        """
